...
<script>
	ipaywebpayment({
			 ...
			 token : {
			 sandbox : 'eyJhbGciOiJIUzUxMiJ9.eyJiYW5rQWNjb3VudCI6ImFjYy4xMjI0NEBMT0ZDQDEiLCJtZXJjaGFudENvZGUiOiIxMjI0NCIsImNyZWF0ZWREYXRlIjoxNTUwMzI4NDQzMDUzLCJtZXJjaGFudElkIjo0MjksImlzVmlydHVhbCI6Ik4iLCJtZXJjaGFudE5hbWUiOiJhYWFhYWFhYWFhYWEifQ.VDUn9GsNRopafxXk6GPFDlTrTGFVHaGRw5Mzx-G15dAmuN_HMpx-JqDKvvsbjCYAetTasZ_G0ALX7L322oYSag'
...
<div class="row" id="maincont">
    <div class="col-sm-9">
    	<button class=" id="btnPay">pay</button>
    	<script>
	ipaywebpayment({
			 env: 'sandbox', // sandbox | production
			 token : {
