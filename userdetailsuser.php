...
<a href="reviewing.php" >Add Review</a>
...
<div class="row">
  ...
  <div class="col-sm-7">
	  <p><?php echo $row['AddressL1'];?></p>
	  <p><?php echo $row['AddressL2'];?></p>
	  <p><?php echo $row['AddressL3'];?></p>
	  <p><?php echo $row['PostalCode'];?></p>
  </div>
</div>
